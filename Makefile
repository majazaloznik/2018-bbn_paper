...
# journals from Rmds ###########################################################
doc00: $(DOC)/00-journal.pdf 

# journal (with graph) render to  pdf
$(DOC)/00-journal.pdf:  $(DOC)/00-journal.Rmd  $(FIG)/make.png 
	$(rmd2pdf)


# journals from Rmds ###########################################################
doc01: $(DOC)/01-potential_journals.pdf 

# journal (with graph) render to  pdf
$(DOC)/01-potential_journals.pdf:  $(DOC)/01-potential_journals.Rmd 
	$(rmd2pdf)

# journals from Rmds ###########################################################
doc01: $(DOC)/02-literature_review.pdf 

# journal (with graph) render to  pdf
$(DOC)/02-literature_review.pdf:  $(DOC)/02-literature_review.Rmd 
	$(rmd2pdf)
